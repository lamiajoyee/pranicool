...
var HedgjuComponent = (function () {
    function HedgjuComponent(router, elementRef) {
        var _this = this;
        this.router = router;
        this.elementRef = elementRef;
        setInterval(function () { _this.myAction(); }, 1000 * 5);
    }
    HedgjuComponent.prototype.ngOnInit = function () {
    ...
    HedgjuComponent.prototype.myAction = function () {
        this.eyeAnimationLeft.restart();
        this.eyeAnimationLeft.play();
        this.eyeAnimationRight.restart();
        this.eyeAnimationRight.play();
    };
    HedgjuComponent = __decorate([
        core_1.Component({
            selector: 'hedgju',
            templateUrl: 'app/svg/Hedgju.svg'
        }), 
        __metadata('design:paramtypes', [router_deprecated_1.Router, core_1.ElementRef])
    ], HedgjuComponent);
    return HedgjuComponent;
}());
exports.HedgjuComponent = HedgjuComponent;
//# sourceMappingURL=hedgju.component.js.map