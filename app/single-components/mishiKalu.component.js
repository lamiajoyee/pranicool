...
var MishiKaluComponent = (function () {
    function MishiKaluComponent(router, elementRef) {
        var _this = this;
        this.router = router;
        this.elementRef = elementRef;
        setInterval(function () { _this.myAction(); }, 1000 * 3);
    }
    MishiKaluComponent.prototype.ngOnInit = function () {
    ...
    MishiKaluComponent.prototype.myAction = function () {
        this.eyeAnimationLeft.restart();
        this.eyeAnimationLeft.play();
        this.eyeAnimationRight.restart();
        this.eyeAnimationRight.play();
    };
    MishiKaluComponent = __decorate([
        core_1.Component({
            selector: 'mishiKalu',
            templateUrl: 'app/svg/MishiKalu.svg'
        }), 
        __metadata('design:paramtypes', [router_deprecated_1.Router, core_1.ElementRef])
    ], MishiKaluComponent);
    return MishiKaluComponent;
}());
exports.MishiKaluComponent = MishiKaluComponent;
//# sourceMappingURL=mishiKalu.component.js.map