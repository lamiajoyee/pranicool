...
var PanduaComponent = (function () {
    function PanduaComponent(router, elementRef) {
        var _this = this;
        this.router = router;
        this.elementRef = elementRef;
        setInterval(function () { _this.myAction(); }, 1000 * 5);
    }
    PanduaComponent.prototype.ngOnInit = function () {
    ...
    PanduaComponent.prototype.myAction = function () {
        this.eyeAnimationLeft.restart();
        this.eyeAnimationLeft.play();
        this.eyeAnimationRight.restart();
        this.eyeAnimationRight.play();
    };
    PanduaComponent = __decorate([
        core_1.Component({
            selector: 'pandua',
            templateUrl: 'app/svg/Pandua.svg'
        }), 
        __metadata('design:paramtypes', [router_deprecated_1.Router, core_1.ElementRef])
    ], PanduaComponent);
    return PanduaComponent;
}());
exports.PanduaComponent = PanduaComponent;
//# sourceMappingURL=pandua.component.js.map