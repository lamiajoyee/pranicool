...
var PiluComponent = (function () {
    function PiluComponent(router, elementRef) {
        var _this = this;
        this.router = router;
        this.elementRef = elementRef;
        setInterval(function () { _this.myAction(); }, 1000 * 6);
    }
    PiluComponent.prototype.ngOnInit = function () {
    ...
    PiluComponent.prototype.myAction = function () {
        this.eyeAnimationLeft.restart();
        this.eyeAnimationLeft.play();
        this.eyeAnimationRight.restart();
        this.eyeAnimationRight.play();
    };
    PiluComponent = __decorate([
        core_1.Component({
            selector: 'pilu',
            templateUrl: 'app/svg/Pilu.svg'
        }), 
        __metadata('design:paramtypes', [router_deprecated_1.Router, core_1.ElementRef])
    ], PiluComponent);
    return PiluComponent;
}());
exports.PiluComponent = PiluComponent;
//# sourceMappingURL=pilu.component.js.map