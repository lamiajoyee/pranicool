...
var RioComponent = (function () {
    function RioComponent(router, elementRef) {
        var _this = this;
        this.router = router;
        this.elementRef = elementRef;
        setInterval(function () { _this.myAction(); }, 1000 * 5);
    }
    RioComponent.prototype.ngOnInit = function () {
