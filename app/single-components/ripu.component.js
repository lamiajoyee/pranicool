...
var RipuComponent = (function () {
    function RipuComponent(router, elementRef) {
        var _this = this;
        this.router = router;
        this.elementRef = elementRef;
        setInterval(function () { _this.myAction(); }, 1000 * 4);
    }
    RipuComponent.prototype.ngOnInit = function () {
    ...
    RipuComponent.prototype.myAction = function () {
        this.eyeAnimationLeft.restart();
        this.eyeAnimationLeft.play();
        this.eyeAnimationRight.restart();
        this.eyeAnimationRight.play();
    };
    RipuComponent = __decorate([
        core_1.Component({
            selector: 'ripu',
            templateUrl: 'app/svg/Ripu.svg'
        }), 
        __metadata('design:paramtypes', [router_deprecated_1.Router, core_1.ElementRef])
    ], RipuComponent);
    return RipuComponent;
}());
exports.RipuComponent = RipuComponent;
//# sourceMappingURL=ripu.component.js.map