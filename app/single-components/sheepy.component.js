...
var SheepyComponent = (function () {
    function SheepyComponent(router, elementRef) {
        var _this = this;
        this.router = router;
        this.elementRef = elementRef;
        setInterval(function () { _this.myAction(); }, 1000 * 5);
        setInterval(function () { _this.talk(); }, 1000 * Math.random() * (9 - 1) + 1);
    }
    SheepyComponent.prototype.ngOnInit = function () {
        ...
        this.mouthOpen = this.group.querySelectorAll("#mouthOpen");
        ...
        this.talkTalk
            .to(this.smile, 0, { opacity: 0 })
            .to(this.mouthOpen, 0, { visibility: "visible" })
            .to(this.mouthOpen, 0.4, { scaleY: 0.9 })
            .to(this.mouthOpen, 0.4, { scaleY: 1 })
            .to(this.mouthOpen, 0.4, { scaleY: 0.9 })
            .to(this.mouthOpen, 0.4, { scaleY: 1 })
            .to(this.mouthOpen, 0.1, { visibility: "hidden" })
            .to(this.smile, 0.3, { opacity: 1 });
    };
    SheepyComponent.prototype.myAction = function () {
        this.eyeAnimationLeft.restart();
        this.eyeAnimationLeft.play();
        this.eyeAnimationRight.restart();
        this.eyeAnimationRight.play();
    };
    SheepyComponent.prototype.talk = function () {
        this.talkTalk.restart();
        this.talkTalk.play();
    };
    SheepyComponent = __decorate([
        core_1.Component({
            selector: 'sheepy',
            templateUrl: 'app/svg/Sheepy.svg'
        }), 
        __metadata('design:paramtypes', [router_deprecated_1.Router, core_1.ElementRef])
    ], SheepyComponent);
    return SheepyComponent;
}());
exports.SheepyComponent = SheepyComponent;
//# sourceMappingURL=sheepy.component.js.map