...
var TimothyComponent = (function () {
    function TimothyComponent(router, elementRef) {
        var _this = this;
        this.router = router;
        this.elementRef = elementRef;
        setInterval(function () { _this.myAction(); }, 1000 * 3);
        setInterval(function () { _this.talk(); }, 1000 * Math.random() * (9 - 1) + 1);
    }
    TimothyComponent.prototype.ngOnInit = function () {
    ...
    TimothyComponent.prototype.myAction = function () {
        this.eyeAnimationLeft.restart();
        this.eyeAnimationLeft.play();
        this.eyeAnimationRight.restart();
        this.eyeAnimationRight.play();
    };
    TimothyComponent.prototype.talk = function () {
        this.talkTalk.restart();
        this.talkTalk.play();
    };
    TimothyComponent = __decorate([
        core_1.Component({
            selector: 'timothy',
            templateUrl: 'app/svg/Timothy.svg'
        }), 
        __metadata('design:paramtypes', [router_deprecated_1.Router, core_1.ElementRef])
    ], TimothyComponent);
    return TimothyComponent;
}());
exports.TimothyComponent = TimothyComponent;
//# sourceMappingURL=timothy.component.js.map